...
#define  SYS_USART_GPIO_APBxClkCmd    RCC_APB2PeriphClockCmd
    
#define  SYS_USART_TX_GPIO_PORT       GPIOA   
#define  SYS_USART_TX_GPIO_PIN        GPIO_Pin_9
#define  SYS_USART_RX_GPIO_PORT       GPIOA
#define  SYS_USART_RX_GPIO_PIN        GPIO_Pin_10

#define  SYS_USART_IRQ                USART1_IRQn
#define  SYS_USART_IRQHandler         USART1_IRQHandler
